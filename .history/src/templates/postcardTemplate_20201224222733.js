  ...
  render () {
    ...
    return (
      <>
        <Helmet>
          <meta charSet="utf-8" />
          <title>{`Photographer Client Gallery Demo` /* Note: not a good idea to put image id here (needs JS to render the correct id). */}</title>
